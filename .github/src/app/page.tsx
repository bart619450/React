...
import NameInput from '../components/uS';  // Komponent dla useState
import Counter from '../components/uR';    // Komponent dla useReducer
import FetchData from '../components/uE';  // Komponent dla useEffect
import { UserProfile, UserProvider } from '../components/uC'; // Poprawiony import
import FocusInput from '../components/uRef'; // Komponent dla useRef
